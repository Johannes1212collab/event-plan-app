        ...
        return new ImageResponse(
            (
                <div style={{
                    ...
                    <div style={{ fontSize: 60 }}>Debug Render</div>
                    <div style={{ fontSize: 40 }}>Title: {event.title}</div>
                    <div style={{ fontSize: 30 }}>Date: {dateStr}</div>
                    <div style={{ fontSize: 30 }}>Host: {event.host?.name}</div>
                    <div style={{ fontSize: 20, marginTop: 20 }}>If you see this, the previous styles were too complex/broken.</div>
                </div>
            ),
            {
                width: 1200,
